...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<input class="date" id="datepicker" type="date" name="fromdate" required min="<?php echo date('Y-m-d'); ?>">
			</div>
			<div class="bnr-right">
				<label class="inputLabel">To</label>
				<input class="date" id="datepicker1" type="date" name="todate" required min="<?php echo date('Y-m-d'); ?>">
			</div>
			</div>
				...
				<div class="grand">
					<p>Grand Total</p>
					<h3>₹ <?php echo number_format(800 * 83, 2); ?> INR</h3>
				</div>
			</div>
